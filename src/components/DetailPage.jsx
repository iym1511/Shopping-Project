  ...
  return (
    ...
    >
              ...
              <div className="detail-textbox">
                <div className="detail-fixbox">
                  ...
                  <div className="detail-count-box">
                    <button
                      onClick={() => {
                        dispatch(CountPlus(shoplist.id));
                      }}
                    >
                      +
                    </button>
                    ...
                    <button
                      onClick={() => {
                        dispatch(CountMinuse(shoplist.id));
                      }}
                    >
                      -
                    </button>
                  ...
                  <button onClick={cartAdd} className="detail-cartbtn">
                    장바구니 담기
                  </button>
          ...
          <div className="detail-container">
            ...
            <div className="detail-textbox">
              <div className="detail-fixbox">
                ...
                <button onClick={logoutMode} className="detail-cartbtn">
                  장바구니 담기
                </button>
                <div className="detail-info">
                  <span>INFO</span>
      ...
      {reviewfind.length != 0 ? (
                    ...
                    findUser && findUser.name == a.name ? (
                      reviewfindId == a.id ? (
                        <>
                          <input
                            type="text"
                            className="detail-modifyInput"
                            value={modifyText}
                            placeholder={a.text}
                            onChange={ModifuonChange}
                          />
                        </>
                      ) : (
                        <>
                    ...
                    <>
                      {
                        ...
                        reviewfindId == a.id ? (
                          ...
                          <>
                            ...
                            >
                              <img
                                src={require("../img/ModifyPencil.png")}
        ...
        <div className="detail-noneReview">
          <p>작성된 리뷰가 없습니다.</p>
        </div>
      )}
