        ...
        <div className="mypage-box">
          ...
          <div className="mypage-sujung-box">
            ...
            >
              ...
              />
              <button type="submit" className="mypage-sujungbtn">
                회원정보 수정
              </button>
            </form>
              ...
              <form onSubmit={deliveryAddress} className="mypage-addressForm">
                ...
                <div className="mypage-addressContainer">
                  <input
                    type="text"
                    placeholder="우편번호"
                    value={apizonecode ? sesstionZonecode : zonecode}
                    onChange={onChangeZonecode}
                    className="mypage-addressNum"
                    disabled
                  />
                  <button
                    onClick={handle.clickButton}
                    className="mypage-apibtn"
                  >
                    주소 검색
                  </button>
                </div>
                <input
                  type="text"
                  placeholder="기본주소"
                  value={apiaddress ? sesstionAddress : address}
                  onChange={onChangeAddress}
                  disabled
                  className="mypage-address"
                />
                <input
                  type="text"
                  placeholder="나머지 주소"
                  ...
                  className="mypage-address"
                />
                <button type="submit" className="mypage-deliverySave">
                  배송지 저장
                </button>
              </form>
            </div>
              ...
              findUser.purchaseArray.map((a, i) => (
                <tr className="mypage-tr-map">
                  <th>
                    <img
                      src={a.image}
                      className="mypage-th-img"
                      onClick={() => {
                        navigate(`/detailpage/${a.id}`);
                      }}
                    />
                  </th>
                  <th>
...

                  {
                    ...
                    findUser &&
                    findUser.purchaseArray.find((e) => e.id == a.id)
                      .reviewCheck ? (
                      <th>
                        <button
                          onClick={() => {
          ...
          <div
            className={`mypage-apiModal ${
              openPostcode ? "mypage-apiModalbod" : ""
            }`}
            ref={modalRef}
          >
            {openPostcode && (
              <DaumPostcode
                className="mypage-api"
